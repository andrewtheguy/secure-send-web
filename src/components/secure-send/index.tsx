          ...
          <div className="space-y-6 pt-4 text-sm">
            <section>
              ...
              <ol className="list-decimal list-inside space-y-1 text-muted-foreground">
                ...
                <li>
                  PIN mode: generate and share the PIN; QR code mode: exchange
                  QR codes between devices
                </li>
                <li>
                  Recipient follows the same mode to complete the encrypted
                  transfer
                </li>
              </ol>
            </section>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Your content is encrypted with AES-256-GCM before it ever
                      leaves your device. Only someone with the PIN or completed
                      QR exchange key can decrypt it.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Files are sent directly between devices using WebRTC. File
                      data never touches a server, only your two devices.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      No sign-ups, no tracking. Each transfer uses a fresh
                      ephemeral identity that's discarded after use.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>
                  ...
                  AES-256-GCM; PIN mode uses PBKDF2-SHA256 key derivation
                  (600,000 iterations), QR code mode uses ECDH
                </li>
                <li>
                  <span className="text-foreground">PIN format:</span> 12
                  characters with built-in checksum for typo detection
                </li>
                <li>
                  <span className="text-foreground">Max size:</span> 100 MB per
                  transfer
                </li>
                <li>
                  <span className="text-foreground">PIN expiry:</span> 1 hour
                </li>
                <li>
                  <span className="text-foreground">Signaling:</span> Receiver
                  chooses the matching mode (PIN mode uses relay signaling, QR
                  code mode uses direct QR exchange)
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground text-sm mb-3">
                Select the mode before sending. Receiver uses the matching mode
              ...
              <div className="space-y-4 text-muted-foreground">
                <div>
                  ...
                  <p className="text-sm">
                    ...
                    Coordination happens through third-party relay servers.
                    Relays can see routing metadata, but not plaintext file
                    contents or your decryption key.
                  </p>
                  <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
                    <li>
                      Best when sender and receiver are on different networks
                      and you want the highest connection success rate.
                    </li>
                    <li>
                      PIN is shared out-of-band (chat, voice, etc.), then
                      receiver enters it to derive the decryption key locally.
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <p className="text-sm">
                    Coordination happens directly through QR code exchange, with
                    no third-party coordination servers. The QR/clipboard
                    signaling payload is obfuscated, not encrypted, so exchange
                    it only with the intended recipient. STUN may be used when
                    internet is available; without internet, no third-party
                    servers are involved at all. When STUN is used, it only sees
                    connection setup metadata such as IP address and port, not
                    file contents or encryption keys. File data remains
                    encrypted throughout the transfer, regardless of internet
                  ...
                  <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
                    ...
                    <li>
                      Offer/answer signaling is exchanged as QR chunks, so no
                      relay coordination service is required.
                    </li>
                    <li>
                      With internet, STUN can assist network traversal for peer
                      connection setup using only connection metadata (for
                      example IP address and port).
                    </li>
                    <li>
                      Without internet, transfer can still work over a shared
                      local network with no third-party servers.
                    </li>
                    <li>
                      Typically less reliable than PIN mode due to camera
